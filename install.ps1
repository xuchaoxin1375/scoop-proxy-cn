...
$SCOOP_PACKAGE_REPO = 'https://github.moeyy.xyz/https://github.com/ScoopInstaller/Scoop/archive/master.zip'
$SCOOP_MAIN_BUCKET_REPO = 'https://github.moeyy.xyz/https://github.com/ScoopInstaller/Main/archive/master.zip'
